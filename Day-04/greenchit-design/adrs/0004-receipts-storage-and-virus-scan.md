...
- Blob metadata tags make the scan result observable and auditable: the audit log can record when a receipt was cleared.
...
- We are tightly coupled to Azure Blob Storage. If BISTEC's cloud strategy changes, migrating stored receipts and replacing the SAS URL generation logic is a complex effort.
